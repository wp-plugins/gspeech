	...
	<div>
		...
		<div class="old_p">
			<label style="margin-right: 50px;">
				...
				<label class="description" for="wpgs_settings[speaker_size_11]"><?php _e('Big', 'wpgs_domain'); ?></label>
				...
				<label class="description" for="wpgs_settings[speaker_size_12]"><?php _e('Small', 'wpgs_domain'); ?></label>
			</label>
	...
	<div>
		...
		<div class="old_p">
			<label style="margin-right: 50px;">
				...
				<label class="description" for="wpgs_settings[speaker_size_21]"><?php _e('Big', 'wpgs_domain'); ?></label>
				...
				<label class="description" for="wpgs_settings[speaker_size_22]"><?php _e('Small', 'wpgs_domain'); ?></label>
			</label>
			<label class="description">Speaker Size</label>
		</div>
		<div class="old_p">
	...
	<div>
		...
		<div class="old_p">
			<label style="margin-right: 50px;">
				...
				<label class="description" for="wpgs_settings[speaker_size_31]"><?php _e('Big', 'wpgs_domain'); ?></label>
				...
				<label class="description" for="wpgs_settings[speaker_size_32]"><?php _e('Small', 'wpgs_domain'); ?></label>
			</label>
			<label class="description">Speaker Size</label>
		</div>
		<div class="old_p">
	...
	<div>
		...
		<div class="old_p">
			<label style="margin-right: 50px;">
				...
				<label class="description" for="wpgs_settings[speaker_size_41]"><?php _e('Big', 'wpgs_domain'); ?></label>
				...
				<label class="description" for="wpgs_settings[speaker_size_42]"><?php _e('Small', 'wpgs_domain'); ?></label>
			</label>
			<label class="description">Speaker Size</label>
		</div>
		<div class="old_p">
	...
	<div>
		...
		<div class="old_p">
			<label style="margin-right: 50px;">
				...
				<label class="description" for="wpgs_settings[speaker_size_51]"><?php _e('Big', 'wpgs_domain'); ?></label>
				...
				<label class="description" for="wpgs_settings[speaker_size_52]"><?php _e('Small', 'wpgs_domain'); ?></label>
			</label>
			<label class="description">Speaker Size</label>
		</div>
		<div class="old_p">
